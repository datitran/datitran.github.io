    ...
    return <Container>
      <Row>
        <Col>
          ...
          <p>I'm currently heading the data science team at <a href='https://www.idealo.de/' className='about__links' target='_blank'>idealo.de</a>. Before that I worked for <a href='https://pivotal.io/' className='about__links' target='_blank'>Pivotal Labs</a> and <a href='https://www.accenture.com/' className='about__links' target='_blank'>Accenture</a>. My interests are diverse from traditional machine learning, deep learning, AI in general to computer vision. I have a lot of experiences from devising realistic data-driven use cases to the actual implementation into a real product; more than capable of distinguishing hype, buzzwords and wannabes from substance.</p>
          <p>I'm a big fan of agile practices, lean product development and open-source technologies. I mainly use Python and the PyData stack for anything that I do but I also know a bit about Apache Spark, TensorFlow, R, SQL and many other stuff. I also regularly blog about my work on <a href='https://medium.com/@datitran' className='about__links' target='_blank'>Medium</a> and also speak at conferences such as PyData.</p>
